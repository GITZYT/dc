...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="/dc/Home/Admin/Login/login.html" method="post">
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                           ...
                           <img  src="<?php echo U(verify);?>" alt="验证码" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onClick="this.src=this.src+'?'+Math.random()" />  
