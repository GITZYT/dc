		  	...
		  	<div class="panel admin-panel">
			    ...
			    <div class="padding border-bottom">
			    	<p>
				        ...
				        <a class="button border-main" href="/dc/Home/Admin/Admin/addcategory"><span class="icon-plus"></span> 新增</a>
			  			<form  id="formid" action="/dc/Home/Admin/Admin/categorylist" method="post">
			  			<input type="text" name="name" value="<?php echo ($name); ?>" class="input input-auto margin-big-left" placeholder="输入类别名称" />
...
<!-- 				      		<th><input type="checkbox" name="ckall" value=""  /></th> -->
				        	...
				        	<td><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>
				          	<td>
			          				...
			          				<div class="form-group" style="display: inline-block;">
										<div class="field text-blue border-main" >
											<div class="button-group radio">
												...
												>
													<input name="isuse" value="1" <?php if($vo["isuse"] == 1): ?>checked="checked"<?php endif; ?>  type="radio"> <a href="/dc/Home/Admin/Admin/qy?id=<?php echo ($vo["id"]); ?>&isuse=1&item=1"><span class="icon icon-check text-white"></span>启用</a>
												</label>
												<label 
												...
												>
													<input name="isuse" value="0"  <?php if($vo["isuse"] == 0): ?>checked="checked"<?php endif; ?> type="radio"> <a href="/dc/Home/Admin/Admin/qy?id=<?php echo ($vo["id"]); ?>&isuse=0&item=1"><span class="icon icon-times"></span>关闭</a>
												</label>
											</div>
										</div>
									</div>
				          		...
				          		<div class="button-group"> 
				          			<a class="button border-main" href="/dc/Home/Admin/Admin/addcategory?id=<?php echo ($vo["id"]); ?>"><span class="icon-edit"></span> 编辑</a> 
		...
		<input type='hidden' value="/dc/Home/Admin/Admin/delete?item=1" id="deleteurl">
		</form>
